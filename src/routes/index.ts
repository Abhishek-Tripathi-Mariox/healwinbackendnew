...
import adminWardStockRoutes from "./admin-ward-stock.routes";
...
import adminPeopleRoutes from "./admin-people.routes";
...
import adminHrCompOffRoutes from "./admin-hr-comp-off.routes";
import adminHrMyAttendanceRoutes from "./admin-hr-my-attendance.routes";
...
router.use("/admin/ward-stock", adminWardStockRoutes);
...
// The unified roster the Employees screen reads. The older staff-directory
// routes stay mounted: the crew attendance view still uses them.
...
router.use("/admin/hr/comp-off", adminHrCompOffRoutes);
router.use("/admin/hr/my-attendance", adminHrMyAttendanceRoutes);
